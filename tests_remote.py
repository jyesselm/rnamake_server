...
def run_full_job(page, driver, jq, d, args=None):
    if args is None:
    ...
    total_time = 0
    job_id = get_job_id_from_url(driver.current_url)
    ...
    while True:
        try:
            ...
            time.sleep(10)
            total_time += 10
            print job_id + " has been runing for: " + str(total_time)
...
class DesignScaffoldTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.page = "http://rnamake.stanford.edu/design_scaffold_app"
